...
{
    public partial class GasRetrofitDtoGen : GeneratedDto<Json.Test.Data.Models.GasRetrofit>
    {
        public GasRetrofitDtoGen() { }
        ...
        /// </summary>
        public override void MapFrom(Json.Test.Data.Models.GasRetrofit obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            ...
            this.NumberOfDials = obj.NumberOfDials;
        ...
        /// </summary>
        public override void MapTo(Json.Test.Data.Models.GasRetrofit entity, IMappingContext context)
        {
            var includes = context.Includes;

            if (OnUpdate(entity, context)) return;

            entity.NumberOfDials = NumberOfDials;

...
module ViewModels {
    ...
    export class PostInstallAudit extends Coalesce.BaseViewModel {
        public readonly modelName = "PostInstallAudit";
        public readonly primaryKeyName = "inspectionId";
        public readonly modelDisplayName = "Post Install Audit";
        public readonly apiController = "/PostInstallAudit";
        public readonly viewController = "/PostInstallAudit";
        
        /** Configuration for all instances of PostInstallAudit. Can be overidden on each instance via instance.coalesceConfig. */
        public static coalesceConfig: Coalesce.ViewModelConfiguration<PostInstallAudit>
            = new Coalesce.ViewModelConfiguration<PostInstallAudit>(Coalesce.GlobalConfiguration.viewModel);
        
        /** Configuration for the current PostInstallAudit instance. */
        public coalesceConfig: Coalesce.ViewModelConfiguration<this>
            = new Coalesce.ViewModelConfiguration<PostInstallAudit>(PostInstallAudit.coalesceConfig);
        
        /** The namespace containing all possible values of this.dataSource. */
        public dataSources: typeof ListViewModels.PostInstallAuditDataSources = ListViewModels.PostInstallAuditDataSources;
        
        
        public postInstallQuestion1: KnockoutObservable<boolean | null> = ko.observable(null);
        public postInstallQuestion2: KnockoutObservable<boolean | null> = ko.observable(null);
        ...
        */
        public loadFromDto = (data: any, force: boolean = false, allowCollectionDeletes: boolean = true): void => {
            ...
            this.postInstallQuestion1(data.postInstallQuestion1);
            this.postInstallQuestion2(data.postInstallQuestion2);
        ...
        public saveToDto = (): any => {
            ...
            dto.postInstallQuestion1 = this.postInstallQuestion1();
            dto.postInstallQuestion2 = this.postInstallQuestion2();
        ...
        */
        ...
        constructor(newItem?: object, parent?: Coalesce.BaseViewModel | ListViewModels.PostInstallAuditList) {
            super(parent);
            this.baseInitialize();
            const self = this;
            ...
            self.postInstallQuestion1.subscribe(self.autoSave);
            self.postInstallQuestion2.subscribe(self.autoSave);
    ...
    export namespace PostInstallAudit {
    }
}
